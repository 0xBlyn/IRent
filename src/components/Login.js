...
function Signup() {
  ...
  return (
    <div className='flex'>
      ...
      }}  className='px-[7%] lg:px-[15%] pt-[120px] lg:pt-0 pb-[3vh] bg-[aliceblue] justify-center text-center flex-[1]'>
      ...
      <h1 className='font-bold text-primary text-xl lg:text-3xl leading-[45px] pt-5 pb-6 justify-center'>Welcome Back</h1>
        <div className='text-left flex flex-col'>
                ...
                <h3 className='text-sm text-primary2 font-bold py-2'>Forgot password?</h3>
                <div className= 'flex pt-[4%] justify-around mb-5 '>
                  <Link to='/signup'><button className='bg-primary rounded-[10px] text-white px-5 py-2 text-[13px]'>
                    Create Account
                  </button></Link>
                  <button className='bg-white rounded-[10px] text-primary px-8  text-[13px] py-2 shadow [1px 4px 54px 13px rgba(0, 0, 0, 0.08)]'><Link to='/login'>Login Now</Link></button>
                </div>
        </div>
        </div>
    </div>
