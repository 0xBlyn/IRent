...
function Signup() {
  ...
  return (
    <div className='flex'>
      ...
      <h1 className='font-bold text-primary text-xl lg:text-3xl leading-[40px] pt-7 pb-3 justify-center lg:mt-12'>Welcome To IRent</h1>
        <div className='text-left flex flex-col'>
                <h1 className='pb-2'>Name</h1>
                <input type='text' placeholder='Enter your name' className='w-full py-[3vh] pl-[3vw] lg:pl-[3vh]  h-[5vh] mb-4 rounded-[10px] shadow [1px 4px 54px 13px rgba(0, 0, 0, 0.08)] bg-white'  />
                <h1 className='pt-2 pb-2'>Email</h1>
                <input type='email' placeholder='Enter your email' className='w-full py-[3vh]  pl-[3vw] lg:pl-[3vh]  h-[5vh] mb-4 rounded-[10px] shadow [1px 4px 54px 13px rgba(0, 0, 0, 0.08)] bg-white' />
                <h1 className='pt-2 pb-2'>Password</h1>
                <input type='text' placeholder='Enter your password' className='w-full py-[3vh]  pl-[3vw] lg:pl-[3vh]  h-[5vh] mb-4 rounded-[10px] shadow [1px 4px 54px 13px rgba(0, 0, 0, 0.08)] bg-white'  />
